...
import { 
  ...
  CheckCircle2, Circle, ArrowRight, Database, Play, RotateCcw, GitBranch, Eye, Cpu, Fingerprint, Vault, Download, BarChart3
} from 'lucide-react';
...
const navItems = [
  ...
  { href: '/traffic', label: 'Traffic', icon: BarChart3, category: 'core' },
  ...
  { href: '/intelligence/download', label: 'Download Report', icon: Download, category: 'intel' },
  ...
  { href: '/route69', label: 'Route 69', icon: FileSearch, category: 'system' },
